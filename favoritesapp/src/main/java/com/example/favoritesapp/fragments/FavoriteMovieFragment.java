...
import com.example.favoritesapp.LoadMoviesCallback;
...
import static com.example.favoritesapp.mapping.MappingHelper.mapCursorToArrayList;
...
//            Log.e("MOVIE", "isi movie : " + movies.getString(1));
